...
### Reporter Styles[​](#reporter-styles "Direct link to Reporter Styles")

TUnit's GitHub reporter supports two output styles:

#### Collapsible Style (Default)[​](#collapsible-style-default "Direct link to Collapsible Style (Default)")
...
#### Full Style (Legacy)[​](#full-style-legacy "Direct link to Full Style (Legacy)")
...
### GitHub Actions Workflow Example[​](#github-actions-workflow-example "Direct link to GitHub Actions Workflow Example")
...
### Disabling the GitHub Reporter[​](#disabling-the-github-reporter "Direct link to Disabling the GitHub Reporter")

If you need to disable the GitHub reporter entirely:

#### Via Environment Variable[​](#via-environment-variable "Direct link to Via Environment Variable")
...
### Multiple Test Projects[​](#multiple-test-projects "Direct link to Multiple Test Projects")
...
### Filtering Test Output[​](#filtering-test-output "Direct link to Filtering Test Output")
...
## Other CI Platforms[​](#other-ci-platforms "Direct link to Other CI Platforms")
...
### GitHub Reporter Not Working[​](#github-reporter-not-working "Direct link to GitHub Reporter Not Working")
...
### Summary Not Appearing[​](#summary-not-appearing "Direct link to Summary Not Appearing")
...
### Large Summary Files[​](#large-summary-files "Direct link to Large Summary Files")
