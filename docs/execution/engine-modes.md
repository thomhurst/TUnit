...
## Source Generation Mode (Default)[​](#source-generation-mode-default "Direct link to Source Generation Mode (Default)")
...
## Reflection Mode[​](#reflection-mode "Direct link to Reflection Mode")
...
### Enabling Reflection Mode[​](#enabling-reflection-mode "Direct link to Enabling Reflection Mode")

There are three ways to enable reflection mode, listed in priority order:

#### 1. Command-Line Flag (Highest Priority)[​](#1-command-line-flag-highest-priority "Direct link to 1. Command-Line Flag (Highest Priority)")

```
dotnet test -- --reflection
```

#### 2. Assembly Attribute (Recommended for Per-Project Configuration)[​](#2-assembly-attribute-recommended-for-per-project-configuration "Direct link to 2. Assembly Attribute (Recommended for Per-Project Configuration)")
...
#### 3. Environment Variable (Global Configuration)[​](#3-environment-variable-global-configuration "Direct link to 3. Environment Variable (Global Configuration)")
...
### Optimizing Build Performance in Reflection Mode[​](#optimizing-build-performance-in-reflection-mode "Direct link to Optimizing Build Performance in Reflection Mode")
...
## Native AOT Support[​](#native-aot-support "Direct link to Native AOT Support")
...
## How Source Generation Works[​](#how-source-generation-works "Direct link to How Source Generation Works")
...
## Publishing with Native AOT[​](#publishing-with-native-aot "Direct link to Publishing with Native AOT")
...
### EditorConfig (.editorconfig)[​](#editorconfig-editorconfig "Direct link to EditorConfig (.editorconfig)")
...
### MSBuild Property[​](#msbuild-property "Direct link to MSBuild Property")
