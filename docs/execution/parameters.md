...
## Passing Parameters[​](#passing-parameters "Direct link to Passing Parameters")
...
## Accessing Parameters in Tests[​](#accessing-parameters-in-tests "Direct link to Accessing Parameters in Tests")
...
### Conditional test logic[​](#conditional-test-logic "Direct link to Conditional test logic")
...
### Passing secrets or connection strings[​](#passing-secrets-or-connection-strings "Direct link to Passing secrets or connection strings")
