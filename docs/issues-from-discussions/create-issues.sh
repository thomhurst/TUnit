#!/bin/bash
# Script to create GitHub issues for discussion #3803
...
echo "Creating GitHub issues for discussion #3803..."
echo

# Issue 1: Constructor Called Twice
echo "Creating Issue 1: Constructor called twice non-deterministically..."
gh issue create \
  --repo "$REPO" \
...
# Issue 2: Constructor Output Lost
echo "Creating Issue 2: Constructor console output not captured..."
gh issue create \
  --repo "$REPO" \
