...
xychart-beta
  ...
  y-axis "Time (ns)" 0 --> 408124
  bar [691.68, 682.23, 399.46, 340102.89, 6792.81, 7257.17]
```
...
xychart-beta
  ...
  x-axis ["TUnit.Mocks", "Imposter", "Mockolate", "Moq", "NSubstitute", "FakeItEasy"]
  y-axis "Time (ns)" 0 --> 104063
  bar [50.64, 329.91, 238.66, 86718.89, 3761.79, 3579.36]
```
...
xychart-beta
  ...
  x-axis ["TUnit.Mocks", "Imposter", "Mockolate", "Moq", "NSubstitute", "FakeItEasy"]
  y-axis "Time (ns)" 0 --> 563543
  bar [1240.92, 1738.64, 1078.38, 469618.42, 12177.9, 13284.98]
```
