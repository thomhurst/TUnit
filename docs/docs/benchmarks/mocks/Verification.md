...
xychart-beta
  ...
  y-axis "Time (ns)" 0 --> 421590
  bar [695.88, 705.19, 422.46, 351324.77, 7107.63, 7895.17]
```
...
xychart-beta
  ...
  x-axis ["TUnit.Mocks", "Imposter", "Mockolate", "Moq", "NSubstitute", "FakeItEasy"]
  y-axis "Time (ns)" 0 --> 108542
  bar [51.78, 335.88, 239.11, 90451.07, 3846.98, 3852.37]
```
...
xychart-beta
  ...
  x-axis ["TUnit.Mocks", "Imposter", "Mockolate", "Moq", "NSubstitute", "FakeItEasy"]
  y-axis "Time (ns)" 0 --> 587683
  bar [1315.71, 1848.88, 1157.64, 489735.48, 12552.98, 13990.18]
```
