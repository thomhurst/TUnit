...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.12.102 | 554.6 ms | 553.2 ms | 4.78 ms |
| NUnit | 4.4.0 | 1,146.6 ms | 1,148.2 ms | 7.99 ms |
| MSTest | 4.0.2 | 1,088.5 ms | 1,087.5 ms | 6.64 ms |
| xUnit3 | 3.2.2 | 1,220.3 ms | 1,219.6 ms | 6.19 ms |
| **TUnit (AOT)** | 1.12.102 | NA | NA | NA |
...
xychart-beta
  ...
  bar [554.6, 1146.6, 1088.5, 1220.3, 0]
```
