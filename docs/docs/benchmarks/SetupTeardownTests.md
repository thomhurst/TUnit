...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.17.54 | 584.4 ms | 583.0 ms | 4.65 ms |
| NUnit | 4.5.0 | 1,173.6 ms | 1,174.0 ms | 10.71 ms |
| MSTest | 4.1.0 | 1,107.6 ms | 1,108.3 ms | 9.12 ms |
| xUnit3 | 3.2.2 | 1,230.0 ms | 1,230.0 ms | 6.30 ms |
...
xychart-beta
  ...
  bar [584.4, 1173.6, 1107.6, 1230, 0]
```
