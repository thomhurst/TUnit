...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.17.54 | 605.7 ms | 605.8 ms | 4.06 ms |
| NUnit | 4.5.0 | 1,183.8 ms | 1,184.3 ms | 8.59 ms |
| MSTest | 4.1.0 | 1,120.0 ms | 1,112.5 ms | 11.96 ms |
| xUnit3 | 3.2.2 | 1,249.8 ms | 1,247.8 ms | 11.59 ms |
...
xychart-beta
  ...
  bar [605.7, 1183.8, 1120, 1249.8, 0]
```
