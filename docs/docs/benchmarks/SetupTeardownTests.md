...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.44.0 | 442.0 ms | 442.2 ms | 1.89 ms |
| NUnit | 4.6.0 | 1,056.8 ms | 1,055.4 ms | 7.84 ms |
| MSTest | 4.2.2 | 992.5 ms | 992.8 ms | 5.61 ms |
| xUnit3 | 3.2.2 | 1,098.0 ms | 1,098.1 ms | 5.83 ms |
