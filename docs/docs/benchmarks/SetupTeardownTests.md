...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.6.20 | 562.2 ms | 561.4 ms | 4.11 ms |
| NUnit | 4.4.0 | 1,203.1 ms | 1,199.8 ms | 14.29 ms |
| MSTest | 4.0.2 | 1,138.7 ms | 1,139.5 ms | 7.18 ms |
| xUnit3 | 3.2.1 | 1,211.0 ms | 1,210.4 ms | 5.31 ms |
...
xychart-beta
  ...
  bar [562.2, 1203.1, 1138.7, 1211, 0]
```
