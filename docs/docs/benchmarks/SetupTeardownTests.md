...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.44.39 | 552.6 ms | 552.0 ms | 3.81 ms |
| NUnit | 4.6.0 | 1,166.2 ms | 1,164.6 ms | 6.58 ms |
| MSTest | 4.2.3 | 1,079.8 ms | 1,079.8 ms | 5.01 ms |
| xUnit3 | 3.2.2 | 1,211.4 ms | 1,212.2 ms | 6.90 ms |
...
xychart-beta
  ...
  bar [552.6, 1166.2, 1079.8, 1211.4, 0]
```
