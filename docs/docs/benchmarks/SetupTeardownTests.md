...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.18.0 | 612.4 ms | 610.4 ms | 8.15 ms |
| NUnit | 4.5.0 | 1,197.8 ms | 1,196.3 ms | 7.04 ms |
| MSTest | 4.1.0 | 1,143.3 ms | 1,138.2 ms | 13.40 ms |
| xUnit3 | 3.2.2 | 1,291.9 ms | 1,283.3 ms | 21.26 ms |
...
xychart-beta
  ...
  bar [612.4, 1197.8, 1143.3, 1291.9, 0]
```
