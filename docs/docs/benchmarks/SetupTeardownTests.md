...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.11.18 | 539.0 ms | 538.2 ms | 3.58 ms |
| NUnit | 4.4.0 | 1,134.1 ms | 1,134.0 ms | 7.11 ms |
| MSTest | 4.0.2 | 1,080.3 ms | 1,081.1 ms | 8.97 ms |
| xUnit3 | 3.2.1 | 1,169.1 ms | 1,167.7 ms | 9.33 ms |
...
xychart-beta
  ...
  y-axis "Time (ms)" 0 --> 1403
  bar [539, 1134.1, 1080.3, 1169.1, 0]
```
