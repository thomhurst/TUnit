...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.45.29 | 560.4 ms | 560.7 ms | 7.10 ms |
| NUnit | 4.6.1 | 1,161.1 ms | 1,159.1 ms | 5.59 ms |
| MSTest | 4.2.3 | 1,081.3 ms | 1,084.0 ms | 6.13 ms |
| xUnit3 | 3.2.2 | 1,229.2 ms | 1,229.7 ms | 8.07 ms |
...
xychart-beta
  ...
  bar [560.4, 1161.1, 1081.3, 1229.2, 0]
```
