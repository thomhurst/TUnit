...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.6.28 | 582.2 ms | 582.2 ms | 3.70 ms |
| NUnit | 4.4.0 | 1,176.8 ms | 1,176.5 ms | 7.44 ms |
| MSTest | 4.0.2 | 1,109.0 ms | 1,108.3 ms | 4.57 ms |
| xUnit3 | 3.2.1 | 1,194.7 ms | 1,193.1 ms | 8.47 ms |
...
xychart-beta
  ...
  bar [582.2, 1176.8, 1109, 1194.7, 0]
```
