...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.6.28 | 598.7 ms | 597.6 ms | 5.30 ms |
| NUnit | 4.4.0 | 1,203.3 ms | 1,199.1 ms | 8.30 ms |
| MSTest | 4.0.2 | 1,144.7 ms | 1,144.0 ms | 6.97 ms |
| xUnit3 | 3.2.1 | 1,228.9 ms | 1,227.6 ms | 8.48 ms |
...
xychart-beta
  ...
  bar [598.7, 1203.3, 1144.7, 1228.9, 0]
```
