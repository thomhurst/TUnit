...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.18.21 | 616.8 ms | 616.0 ms | 6.32 ms |
| NUnit | 4.5.0 | 1,163.3 ms | 1,161.9 ms | 7.30 ms |
| MSTest | 4.1.0 | 1,100.3 ms | 1,098.4 ms | 7.13 ms |
| xUnit3 | 3.2.2 | 1,239.6 ms | 1,238.6 ms | 6.19 ms |
...
xychart-beta
  ...
  bar [616.8, 1163.3, 1100.3, 1239.6, 0]
```
