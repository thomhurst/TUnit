...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.41.0 | 443.7 ms | 443.2 ms | 1.96 ms |
| NUnit | 4.5.1 | 1,063.6 ms | 1,065.1 ms | 4.14 ms |
| MSTest | 4.2.2 | 1,002.1 ms | 1,000.6 ms | 10.49 ms |
| xUnit3 | 3.2.2 | 1,099.7 ms | 1,101.2 ms | 6.13 ms |
...
xychart-beta
  ...
  bar [443.7, 1063.6, 1002.1, 1099.7, 0]
```
