...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.5.53 | 562.2 ms | 562.1 ms | 3.38 ms |
| NUnit | 4.4.0 | 1,275.5 ms | 1,276.0 ms | 14.27 ms |
| MSTest | 4.0.2 | 1,099.4 ms | 1,098.7 ms | 7.22 ms |
| xUnit3 | 3.2.1 | 1,187.0 ms | 1,181.4 ms | 11.68 ms |
...
xychart-beta
  ...
  bar [562.2, 1275.5, 1099.4, 1187, 0]
```
