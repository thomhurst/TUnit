...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.12.53 | 544.5 ms | 544.2 ms | 3.99 ms |
| NUnit | 4.4.0 | 1,169.6 ms | 1,168.2 ms | 8.14 ms |
| MSTest | 4.0.2 | 1,124.0 ms | 1,121.4 ms | 11.56 ms |
| xUnit3 | 3.2.2 | 1,245.9 ms | 1,246.2 ms | 10.02 ms |
...
xychart-beta
  ...
  bar [544.5, 1169.6, 1124, 1245.9, 0]
```
