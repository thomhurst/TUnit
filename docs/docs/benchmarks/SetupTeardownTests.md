...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.9.55 | 730.9 ms | 731.9 ms | 13.51 ms |
| NUnit | 4.4.0 | 1,249.2 ms | 1,246.4 ms | 17.47 ms |
| MSTest | 4.0.2 | 1,169.3 ms | 1,167.8 ms | 9.33 ms |
| xUnit3 | 3.2.1 | 1,254.0 ms | 1,252.8 ms | 7.02 ms |
...
xychart-beta
  ...
  bar [730.9, 1249.2, 1169.3, 1254, 0]
```
