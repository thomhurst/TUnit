...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.12.3 | 534.8 ms | 533.9 ms | 3.93 ms |
| NUnit | 4.4.0 | 1,162.6 ms | 1,163.2 ms | 5.62 ms |
| MSTest | 4.0.2 | 1,127.1 ms | 1,129.3 ms | 7.94 ms |
| xUnit3 | 3.2.2 | 1,240.5 ms | 1,239.8 ms | 7.51 ms |
...
xychart-beta
  ...
  bar [534.8, 1162.6, 1127.1, 1240.5, 0]
```
