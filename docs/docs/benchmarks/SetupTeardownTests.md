...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.12.111 | 545.3 ms | 545.8 ms | 2.54 ms |
| NUnit | 4.4.0 | 1,149.2 ms | 1,144.0 ms | 10.52 ms |
| MSTest | 4.0.2 | 1,089.1 ms | 1,090.6 ms | 7.21 ms |
| xUnit3 | 3.2.2 | 1,200.8 ms | 1,200.4 ms | 3.96 ms |
...
xychart-beta
  ...
  bar [545.3, 1149.2, 1089.1, 1200.8, 0]
```
