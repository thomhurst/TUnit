...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.30.8 | 561.3 ms | 560.7 ms | 2.29 ms |
| NUnit | 4.5.1 | 1,166.7 ms | 1,166.6 ms | 5.26 ms |
| MSTest | 4.2.1 | 1,079.0 ms | 1,075.9 ms | 6.49 ms |
| xUnit3 | 3.2.2 | 1,221.1 ms | 1,222.6 ms | 7.98 ms |
...
xychart-beta
  ...
  bar [561.3, 1166.7, 1079, 1221.1, 0]
```
