...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.2.11 | 584.4 ms | 584.6 ms | 6.90 ms |
| NUnit | 4.4.0 | 1,172.5 ms | 1,170.6 ms | 7.24 ms |
| MSTest | 4.0.2 | 1,145.4 ms | 1,144.0 ms | 13.26 ms |
| xUnit3 | 3.2.0 | 1,245.2 ms | 1,247.0 ms | 17.89 ms |
...
xychart-beta
  ...
  bar [584.4, 1172.5, 1145.4, 1245.2, 0]
```
