...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.2.11 | 562.5 ms | 562.3 ms | 3.82 ms |
| NUnit | 4.4.0 | 1,181.4 ms | 1,181.3 ms | 11.56 ms |
| MSTest | 4.0.2 | 1,151.1 ms | 1,150.2 ms | 6.04 ms |
| xUnit3 | 3.2.0 | 1,231.9 ms | 1,230.6 ms | 6.20 ms |
...
xychart-beta
  ...
  bar [562.5, 1181.4, 1151.1, 1231.9, 0]
```
