...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.40.0 | 563.3 ms | 563.8 ms | 4.00 ms |
| NUnit | 4.5.1 | 1,215.9 ms | 1,215.6 ms | 10.62 ms |
| MSTest | 4.2.1 | 1,129.6 ms | 1,132.2 ms | 9.37 ms |
| xUnit3 | 3.2.2 | 1,258.7 ms | 1,257.1 ms | 6.27 ms |
...
xychart-beta
  ...
  bar [563.3, 1215.9, 1129.6, 1258.7, 0]
```
