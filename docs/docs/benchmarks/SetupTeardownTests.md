...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.17.7 | 575.8 ms | 575.0 ms | 2.78 ms |
| NUnit | 4.5.0 | 1,177.7 ms | 1,178.1 ms | 7.42 ms |
| MSTest | 4.1.0 | 1,115.0 ms | 1,115.1 ms | 6.54 ms |
| xUnit3 | 3.2.2 | 1,243.8 ms | 1,242.1 ms | 6.44 ms |
...
xychart-beta
  ...
  bar [575.8, 1177.7, 1115, 1243.8, 0]
```
