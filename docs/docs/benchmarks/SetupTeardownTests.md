...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.19.22 | 573.3 ms | 573.2 ms | 2.31 ms |
| NUnit | 4.5.1 | 1,221.5 ms | 1,220.9 ms | 7.61 ms |
| MSTest | 4.1.0 | 1,163.6 ms | 1,162.4 ms | 7.96 ms |
| xUnit3 | 3.2.2 | 1,291.9 ms | 1,289.0 ms | 10.29 ms |
...
xychart-beta
  ...
  bar [573.3, 1221.5, 1163.6, 1291.9, 0]
```
