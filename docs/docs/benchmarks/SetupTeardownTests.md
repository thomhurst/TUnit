...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.9.68 | 689.2 ms | 690.0 ms | 5.66 ms |
| NUnit | 4.4.0 | 1,211.7 ms | 1,206.9 ms | 13.10 ms |
| MSTest | 4.0.2 | 1,157.3 ms | 1,155.4 ms | 16.47 ms |
| xUnit3 | 3.2.1 | 1,235.9 ms | 1,236.0 ms | 5.46 ms |
...
xychart-beta
  ...
  bar [689.2, 1211.7, 1157.3, 1235.9, 0]
```
