...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.19.16 | 623.7 ms | 622.6 ms | 5.16 ms |
| NUnit | 4.5.1 | 1,193.7 ms | 1,195.2 ms | 10.39 ms |
| MSTest | 4.1.0 | 1,135.5 ms | 1,138.0 ms | 10.38 ms |
| xUnit3 | 3.2.2 | 1,270.9 ms | 1,271.7 ms | 11.75 ms |
| **TUnit (AOT)** | 1.19.16 | NA | NA | NA |
...
xychart-beta
  ...
  bar [623.7, 1193.7, 1135.5, 1270.9, 0]
```
