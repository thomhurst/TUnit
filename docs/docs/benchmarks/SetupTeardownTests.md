...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.6.28 | 583.9 ms | 582.1 ms | 9.48 ms |
| NUnit | 4.4.0 | 1,220.1 ms | 1,219.9 ms | 4.86 ms |
| MSTest | 4.0.2 | 1,157.0 ms | 1,158.9 ms | 4.58 ms |
| xUnit3 | 3.2.1 | 1,235.7 ms | 1,235.8 ms | 9.42 ms |
...
xychart-beta
  ...
  bar [583.9, 1220.1, 1157, 1235.7, 0]
```
