...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.11.18 | 443.08 ms | 442.63 ms | 4.851 ms |
| NUnit | 4.4.0 | 572.03 ms | 572.36 ms | 13.965 ms |
| MSTest | 4.0.2 | 584.18 ms | 584.58 ms | 15.026 ms |
| xUnit3 | 3.2.1 | 584.03 ms | 582.88 ms | 8.933 ms |
| **TUnit (AOT)** | 1.11.18 | 22.83 ms | 22.86 ms | 0.393 ms |
...
xychart-beta
  ...
  bar [443.08, 572.03, 584.18, 584.03, 22.83]
```
