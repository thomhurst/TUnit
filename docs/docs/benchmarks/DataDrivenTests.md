...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.11.28 | 474.43 ms | 474.23 ms | 7.745 ms |
| NUnit | 4.4.0 | 587.60 ms | 587.47 ms | 14.704 ms |
| MSTest | 4.0.2 | 553.14 ms | 553.29 ms | 17.074 ms |
| xUnit3 | 3.2.2 | 643.96 ms | 643.91 ms | 9.637 ms |
| **TUnit (AOT)** | 1.11.28 | 25.39 ms | 25.37 ms | 0.389 ms |
...
xychart-beta
  ...
  bar [474.43, 587.6, 553.14, 643.96, 25.39]
```
