...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.7.7 | 500.39 ms | 499.50 ms | 5.626 ms |
| NUnit | 4.4.0 | 560.39 ms | 559.68 ms | 7.687 ms |
| MSTest | 4.0.2 | 550.59 ms | 549.50 ms | 10.445 ms |
| xUnit3 | 3.2.1 | 580.34 ms | 579.72 ms | 6.798 ms |
| **TUnit (AOT)** | 1.7.7 | 23.97 ms | 24.00 ms | 0.076 ms |
...
xychart-beta
  ...
  bar [500.39, 560.39, 550.59, 580.34, 23.97]
```
