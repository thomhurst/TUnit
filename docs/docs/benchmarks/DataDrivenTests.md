...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.5.48 | 501.17 ms | 501.99 ms | 3.580 ms |
| NUnit | 4.4.0 | 614.30 ms | 615.51 ms | 6.737 ms |
| MSTest | 4.0.2 | 486.97 ms | 488.04 ms | 6.993 ms |
| xUnit3 | 3.2.1 | 570.33 ms | 570.25 ms | 4.012 ms |
| **TUnit (AOT)** | 1.5.48 | 24.64 ms | 24.80 ms | 0.339 ms |
...
xychart-beta
  ...
  bar [501.17, 614.3, 486.97, 570.33, 24.64]
```
