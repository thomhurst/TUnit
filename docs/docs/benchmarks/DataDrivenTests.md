...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.13.8 | 448.93 ms | 448.60 ms | 3.284 ms |
| NUnit | 4.4.0 | 654.66 ms | 653.90 ms | 8.443 ms |
| MSTest | 4.1.0 | 656.98 ms | 658.09 ms | 7.525 ms |
| xUnit3 | 3.2.2 | 659.36 ms | 659.89 ms | 11.428 ms |
| **TUnit (AOT)** | 1.13.8 | 24.56 ms | 24.56 ms | 0.952 ms |
...
xychart-beta
  ...
  bar [448.93, 654.66, 656.98, 659.36, 24.56]
```
