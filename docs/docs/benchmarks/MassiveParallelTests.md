...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.5.53 | 608.4 ms | 607.9 ms | 8.12 ms |
| NUnit | 4.4.0 | 1,268.1 ms | 1,268.7 ms | 5.14 ms |
| MSTest | 4.0.2 | 2,956.9 ms | 2,956.7 ms | 7.66 ms |
| xUnit3 | 3.2.1 | 3,062.7 ms | 3,062.4 ms | 7.81 ms |
| **TUnit (AOT)** | 1.5.53 | 131.6 ms | 131.6 ms | 0.45 ms |
...
xychart-beta
  ...
  bar [608.4, 1268.1, 2956.9, 3062.7, 131.6]
```
