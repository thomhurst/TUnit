...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.3.25 | 602.6 ms | 603.7 ms | 4.06 ms |
| NUnit | 4.4.0 | 1,191.7 ms | 1,192.7 ms | 6.96 ms |
| MSTest | 4.0.2 | 2,973.0 ms | 2,971.9 ms | 10.85 ms |
| xUnit3 | 3.2.1 | 3,065.1 ms | 3,064.9 ms | 7.78 ms |
| **TUnit (AOT)** | 1.3.25 | 131.1 ms | 131.1 ms | 0.51 ms |
...
xychart-beta
  ...
  bar [602.6, 1191.7, 2973, 3065.1, 131.1]
```
