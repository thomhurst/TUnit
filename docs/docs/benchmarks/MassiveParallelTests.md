...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.3.0 | 603.0 ms | 602.8 ms | 6.72 ms |
| NUnit | 4.4.0 | 1,206.9 ms | 1,207.7 ms | 4.41 ms |
| MSTest | 4.0.2 | 2,985.7 ms | 2,982.1 ms | 8.25 ms |
| xUnit3 | 3.2.0 | 3,082.7 ms | 3,082.0 ms | 9.56 ms |
| **TUnit (AOT)** | 1.3.0 | 131.5 ms | 131.6 ms | 0.41 ms |
...
xychart-beta
  ...
  y-axis "Time (ms)" 0 --> 3700
  bar [603, 1206.9, 2985.7, 3082.7, 131.5]
```
