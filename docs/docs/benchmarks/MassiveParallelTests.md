...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.2.11 | 603.5 ms | 603.0 ms | 3.89 ms |
| NUnit | 4.4.0 | 1,213.0 ms | 1,213.1 ms | 7.41 ms |
| MSTest | 4.0.2 | 3,000.0 ms | 2,998.4 ms | 9.38 ms |
| xUnit3 | 3.2.0 | 3,089.8 ms | 3,087.9 ms | 8.18 ms |
| **TUnit (AOT)** | 1.2.11 | 131.4 ms | 131.3 ms | 0.36 ms |
...
xychart-beta
  ...
  y-axis "Time (ms)" 0 --> 3708
  bar [603.5, 1213, 3000, 3089.8, 131.4]
```
