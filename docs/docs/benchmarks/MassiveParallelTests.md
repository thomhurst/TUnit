...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.2.11 | 589.0 ms | 585.7 ms | 8.74 ms |
| NUnit | 4.4.0 | 1,197.0 ms | 1,196.7 ms | 4.87 ms |
| MSTest | 4.0.2 | 2,999.4 ms | 2,999.0 ms | 4.44 ms |
| xUnit3 | 3.2.0 | 3,085.6 ms | 3,085.6 ms | 8.46 ms |
| **TUnit (AOT)** | 1.2.11 | 130.1 ms | 130.1 ms | 0.49 ms |
...
xychart-beta
  ...
  bar [589, 1197, 2999.4, 3085.6, 130.1]
```
