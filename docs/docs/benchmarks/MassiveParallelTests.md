...
|-----------|---------|------|--------|--------|
| **TUnit** | 1.5.80 | 566.1 ms | 565.9 ms | 4.05 ms |
| NUnit | 4.4.0 | 1,210.4 ms | 1,211.5 ms | 5.48 ms |
| MSTest | 4.0.2 | 2,986.8 ms | 2,987.1 ms | 6.08 ms |
| xUnit3 | 3.2.1 | 3,061.3 ms | 3,060.5 ms | 6.89 ms |
| **TUnit (AOT)** | 1.5.80 | 129.3 ms | 129.2 ms | 0.45 ms |
...
xychart-beta
  ...
  bar [566.1, 1210.4, 2986.8, 3061.3, 129.3]
```
