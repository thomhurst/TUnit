...
- `[Fact]` → `[Test]`, `[Theory]` → `[Test]`
- xUnit assertions to TUnit's fluent syntax
- `[InlineData]` → `[Arguments]`, `[MemberData]` → `[MethodDataSource]`
- Constructors and IDisposable to TUnit hooks
