...
## How to fix it[​](#how-to-fix-it "Direct link to How to fix it")
...
See [Hook Parameters](/docs/writing-tests/hooks.md#hook-parameters) for the supported hook signatures.
