...
## Test Discovery Performance[​](#test-discovery-performance "Direct link to Test Discovery Performance")

### Use AOT Mode[​](#use-aot-mode "Direct link to Use AOT Mode")
...
### Optimize Data Sources[​](#optimize-data-sources "Direct link to Optimize Data Sources")

#### Keep Data Generation Lightweight[​](#keep-data-generation-lightweight "Direct link to Keep Data Generation Lightweight")
...
#### Use Lazy Data Loading[​](#use-lazy-data-loading "Direct link to Use Lazy Data Loading")
...
### Limit Matrix Test Combinations[​](#limit-matrix-test-combinations "Direct link to Limit Matrix Test Combinations")
...
## Test Execution Performance[​](#test-execution-performance "Direct link to Test Execution Performance")

### Optimize Parallel Execution[​](#optimize-parallel-execution "Direct link to Optimize Parallel Execution")

#### Configure Appropriate Parallelism[​](#configure-appropriate-parallelism "Direct link to Configure Appropriate Parallelism")
...
#### Group Related Tests[​](#group-related-tests "Direct link to Group Related Tests")
...
#### Use Parallel Limiters Wisely[​](#use-parallel-limiters-wisely "Direct link to Use Parallel Limiters Wisely")
...
### Minimize Test Setup Overhead[​](#minimize-test-setup-overhead "Direct link to Minimize Test Setup Overhead")

#### Share Expensive Setup[​](#share-expensive-setup "Direct link to Share Expensive Setup")
...
#### Use Lazy Initialization[​](#use-lazy-initialization "Direct link to Use Lazy Initialization")
...
### Optimize Assertions[​](#optimize-assertions "Direct link to Optimize Assertions")

#### Avoid Expensive Operations in Assertions[​](#avoid-expensive-operations-in-assertions "Direct link to Avoid Expensive Operations in Assertions")
...
### Avoid Memory Leaks in Static Fields[​](#avoid-memory-leaks-in-static-fields "Direct link to Avoid Memory Leaks in Static Fields")
...
### Use ValueTask for High-Frequency Operations[​](#use-valuetask-for-high-frequency-operations "Direct link to Use ValueTask for High-Frequency Operations")
...
## I/O Performance[​](#io-performance "Direct link to I/O Performance")
...
### Use Async I/O[​](#use-async-io "Direct link to Use Async I/O")
...
### Cache File Contents[​](#cache-file-contents "Direct link to Cache File Contents")
...
## Database Testing Performance[​](#database-testing-performance "Direct link to Database Testing Performance")

### Use Transaction Rollback[​](#use-transaction-rollback "Direct link to Use Transaction Rollback")
...
## CI/CD Optimization[​](#cicd-optimization "Direct link to CI/CD Optimization")

### Split Test Suites[​](#split-test-suites "Direct link to Split Test Suites")
...
### Fail Fast in CI[​](#fail-fast-in-ci "Direct link to Fail Fast in CI")
