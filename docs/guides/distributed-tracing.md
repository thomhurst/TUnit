...
## What TUnit emits[​](#what-tunit-emits "Direct link to What TUnit emits")
...
## Backend setup[​](#backend-setup "Direct link to Backend setup")
...
### Aspire dashboard[​](#aspire-dashboard "Direct link to Aspire dashboard")
...
### Other backends (Honeycomb, Datadog, etc.)[​](#other-backends-honeycomb-datadog-etc "Direct link to Other backends (Honeycomb, Datadog, etc.)")
...
## How to find spans for a test[​](#how-to-find-spans-for-a-test "Direct link to How to find spans for a test")
...
## When tracing across processes[​](#when-tracing-across-processes "Direct link to When tracing across processes")
...
### Static `ActivitySource` in third-party libraries[​](#static-activitysource-in-third-party-libraries "Direct link to static-activitysource-in-third-party-libraries")
...
### `WebApplicationFactory` without TUnit's wrapper[​](#webapplicationfactory-without-tunits-wrapper "Direct link to webapplicationfactory-without-tunits-wrapper")
...
### `IHttpClientFactory` clients in the SUT[​](#ihttpclientfactory-clients-in-the-sut "Direct link to ihttpclientfactory-clients-in-the-sut")
...
### SUT-side OpenTelemetry wiring[​](#sut-side-opentelemetry-wiring "Direct link to SUT-side OpenTelemetry wiring")
...
### Raw `HttpClient`[​](#raw-httpclient "Direct link to raw-httpclient")

`new HttpClient()` can't be intercepted. Either route through `IHttpClientFactory` or set the `traceparent` header manually.

## Capturing spans from out-of-process SUTs[​](#capturing-spans-from-out-of-process-suts "Direct link to Capturing spans from out-of-process SUTs")
...
## HTML report vs OpenTelemetry backends[​](#html-report-vs-opentelemetry-backends "Direct link to HTML report vs OpenTelemetry backends")
