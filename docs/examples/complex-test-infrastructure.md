...
## Real-World Example: Full Stack Integration Testing[​](#real-world-example-full-stack-integration-testing "Direct link to Real-World Example: Full Stack Integration Testing")
...
## Property Injection Chains[​](#property-injection-chains "Direct link to Property Injection Chains")
...
### Example: Docker Network Orchestration[​](#example-docker-network-orchestration "Direct link to Example: Docker Network Orchestration")
...
### Example: Kafka Container with Network Injection[​](#example-kafka-container-with-network-injection "Direct link to Example: Kafka Container with Network Injection")
...
### Example: Kafka UI Depending on Kafka Container[​](#example-kafka-ui-depending-on-kafka-container "Direct link to Example: Kafka UI Depending on Kafka Container")
...
## Complete Integration: Web Application with Multiple Dependencies[​](#complete-integration-web-application-with-multiple-dependencies "Direct link to Complete Integration: Web Application with Multiple Dependencies")
...
### 1. **Automatic Dependency Resolution**[​](#1-automatic-dependency-resolution "Direct link to 1-automatic-dependency-resolution")
...
### 2. **Reduced Boilerplate**[​](#2-reduced-boilerplate "Direct link to 2-reduced-boilerplate")
...
### 3. **Resource Sharing**[​](#3-resource-sharing "Direct link to 3-resource-sharing")
...
### 4. **Clean Separation of Concerns**[​](#4-clean-separation-of-concerns "Direct link to 4-clean-separation-of-concerns")
...
### EF Core Code First with Per-Test Schema Isolation[​](#ef-core-code-first-with-per-test-schema-isolation "Direct link to EF Core Code First with Per-Test Schema Isolation")
...
## Comparison with Other Frameworks[​](#comparison-with-other-frameworks "Direct link to Comparison with Other Frameworks")
...
### With TUnit[​](#with-tunit "Direct link to With TUnit")
...
## Multiple Test Projects and SharedType.PerTestSession[​](#multiple-test-projects-and-sharedtypepertestsession "Direct link to Multiple Test Projects and SharedType.PerTestSession")
