...
## Using File-Based C# Application with TUnit[​](#using-file-based-c-application-with-tunit "Direct link to Using File-Based C# Application with TUnit")
...
## Using msbuild props with File-Based C# Application[​](#using-msbuild-props-with-file-based-c-application "Direct link to Using msbuild props with File-Based C# Application")
