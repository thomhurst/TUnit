...
### Complete Workflow with Matrix Strategy[​](#complete-workflow-with-matrix-strategy "Direct link to Complete Workflow with Matrix Strategy")
...
### Workflow with AOT Testing[​](#workflow-with-aot-testing "Direct link to Workflow with AOT Testing")
...
### PR Comment with Test Results[​](#pr-comment-with-test-results "Direct link to PR Comment with Test Results")
...
### Complete Pipeline with Stages[​](#complete-pipeline-with-stages "Direct link to Complete Pipeline with Stages")
...
### Multi-Platform Testing Matrix[​](#multi-platform-testing-matrix "Direct link to Multi-Platform Testing Matrix")
...
### Complete Pipeline with Stages[​](#complete-pipeline-with-stages-1 "Direct link to Complete Pipeline with Stages")
...
### Matrix Testing Multiple .NET Versions[​](#matrix-testing-multiple-net-versions "Direct link to Matrix Testing Multiple .NET Versions")
...
### Dockerfile for Running Tests[​](#dockerfile-for-running-tests "Direct link to Dockerfile for Running Tests")
...
### Docker Compose for Integration Tests[​](#docker-compose-for-integration-tests "Direct link to Docker Compose for Integration Tests")
...
### Separate Restore, Build, and Test[​](#separate-restore-build-and-test "Direct link to Separate Restore, Build, and Test")
...
### Use Caching[​](#use-caching "Direct link to Use Caching")
...
### Parallel Test Execution[​](#parallel-test-execution "Direct link to Parallel Test Execution")
...
### Filter Tests by Category[​](#filter-tests-by-category "Direct link to Filter Tests by Category")
...
### Fail Fast in PRs[​](#fail-fast-in-prs "Direct link to Fail Fast in PRs")
...
### Tests Timing Out[​](#tests-timing-out "Direct link to Tests Timing Out")
...
### Coverage Files Not Generated[​](#coverage-files-not-generated "Direct link to Coverage Files Not Generated")
...
### Out of Memory in CI[​](#out-of-memory-in-ci "Direct link to Out of Memory in CI")
