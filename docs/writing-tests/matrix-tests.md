...
## Matrix Range[​](#matrix-range "Direct link to Matrix Range")
...
## Matrix Method[​](#matrix-method "Direct link to Matrix Method")
...
## Matrix Exclusions[​](#matrix-exclusions "Direct link to Matrix Exclusions")
