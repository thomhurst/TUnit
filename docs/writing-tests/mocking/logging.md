...
## Creating a Logger[​](#creating-a-logger "Direct link to Creating a Logger")
...
### Fluent API[​](#fluent-api "Direct link to Fluent API")
...
### Shorthand Methods[​](#shorthand-methods "Direct link to Shorthand Methods")
