...
## AOT-Compatible Property Attributes[​](#aot-compatible-property-attributes "Direct link to AOT-Compatible Property Attributes")
...
## Async Property Initialization[​](#async-property-initialization "Direct link to Async Property Initialization")
...
## Discovery Phase Initialization[​](#discovery-phase-initialization "Direct link to Discovery Phase Initialization")

### When Discovery Initialization is Needed[​](#when-discovery-initialization-is-needed "Direct link to When Discovery Initialization is Needed")
...
### Example: Discovery-Time Initialization[​](#example-discovery-time-initialization "Direct link to Example: Discovery-Time Initialization")
...
## Basic Property Injection Examples[​](#basic-property-injection-examples "Direct link to Basic Property Injection Examples")
...
## Nested Property Injection[​](#nested-property-injection "Direct link to Nested Property Injection")
...
### Example: Complex Test Infrastructure[​](#example-complex-test-infrastructure "Direct link to Example: Complex Test Infrastructure")
...
### Benefits of Nested Property Injection[​](#benefits-of-nested-property-injection "Direct link to Benefits of Nested Property Injection")
...
### Sharing Strategies[​](#sharing-strategies "Direct link to Sharing Strategies")
...
#### Conditional Initialization[​](#conditional-initialization "Direct link to Conditional Initialization")
