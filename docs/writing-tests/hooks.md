...
## Hook Parameters[​](#hook-parameters "Direct link to Hook Parameters")
...
### Checking Test Results in Cleanup[​](#checking-test-results-in-cleanup "Direct link to Checking Test Results in Cleanup")
...
## Setup Hooks: \[Before] and \[BeforeEvery][​](#setup-hooks-before-and-beforeevery "Direct link to Setup Hooks: \[Before] and \[BeforeEvery]")

### \[Before(HookType)][​](#beforehooktype "Direct link to \[Before(HookType)]")
...
### \[BeforeEvery(HookType)][​](#beforeeveryhooktype "Direct link to \[BeforeEvery(HookType)]")
...
### Setup Example[​](#setup-example "Direct link to Setup Example")
...
## Cleanup Hooks: \[After] and \[AfterEvery][​](#cleanup-hooks-after-and-afterevery "Direct link to Cleanup Hooks: \[After] and \[AfterEvery]")
...
### \[After(HookType)][​](#afterhooktype "Direct link to \[After(HookType)]")
...
### \[AfterEvery(HookType)][​](#aftereveryhooktype "Direct link to \[AfterEvery(HookType)]")
...
### Cleanup Example[​](#cleanup-example "Direct link to Cleanup Example")
...
## AsyncLocal[​](#asynclocal "Direct link to AsyncLocal")
