...
## Test-Level Artifacts[​](#test-level-artifacts "Direct link to Test-Level Artifacts")

Attach files to individual tests using `TestContext.Current.Output.AttachArtifact()`.

### Writing Artifacts to the Results Directory[​](#writing-artifacts-to-the-results-directory "Direct link to Writing Artifacts to the Results Directory")
...
### Attaching Screenshots on Failure[​](#attaching-screenshots-on-failure "Direct link to Attaching Screenshots on Failure")
...
### Attaching Multiple Artifacts[​](#attaching-multiple-artifacts "Direct link to Attaching Multiple Artifacts")
...
## Session-Level Artifacts[​](#session-level-artifacts "Direct link to Session-Level Artifacts")
...
### Performance Reports[​](#performance-reports "Direct link to Performance Reports")
...
## Artifact Class[​](#artifact-class "Direct link to Artifact Class")
...
### 1. Clean Up Artifacts[​](#1-clean-up-artifacts "Direct link to 1. Clean Up Artifacts")
...
### 2. Organize Artifacts by Test[​](#2-organize-artifacts-by-test "Direct link to 2. Organize Artifacts by Test")
...
### 3. Only Attach on Failure[​](#3-only-attach-on-failure "Direct link to 3. Only Attach on Failure")
...
### 4. Use Descriptive Names[​](#4-use-descriptive-names "Direct link to 4. Use Descriptive Names")
...
### 5. Verify Files Exist[​](#5-verify-files-exist "Direct link to 5. Verify Files Exist")
...
### Browser Testing with Playwright[​](#browser-testing-with-playwright "Direct link to Browser Testing with Playwright")
...
## Integration with Test Runners[​](#integration-with-test-runners "Direct link to Integration with Test Runners")
