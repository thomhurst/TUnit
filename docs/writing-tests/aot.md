...
## Generic Test Instantiation[​](#generic-test-instantiation "Direct link to Generic Test Instantiation")

Generic test classes and methods require explicit type instantiation for AOT compatibility.

### Generic Test Methods[​](#generic-test-methods "Direct link to Generic Test Methods")
...
### Generic Test Classes[​](#generic-test-classes "Direct link to Generic Test Classes")
...
## AOT-Compatible Data Sources[​](#aot-compatible-data-sources "Direct link to AOT-Compatible Data Sources")

### Static Data Sources[​](#static-data-sources "Direct link to Static Data Sources")
...
### Async Data Sources with Cancellation[​](#async-data-sources-with-cancellation "Direct link to Async Data Sources with Cancellation")
...
## Advanced Property Injection[​](#advanced-property-injection "Direct link to Advanced Property Injection")

### Service Provider Integration[​](#service-provider-integration "Direct link to Service Provider Integration")
...
## Compile-Time Diagnostics[​](#compile-time-diagnostics "Direct link to Compile-Time Diagnostics")
...
### Data Source Diagnostics[​](#data-source-diagnostics "Direct link to Data Source Diagnostics")
