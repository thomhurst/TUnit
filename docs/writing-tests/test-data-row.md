...
## Display Name Substitution[​](#display-name-substitution "Direct link to Display Name Substitution")
...
## Working with Complex Types[​](#working-with-complex-types "Direct link to Working with Complex Types")
...
## With Func\<T> for Reference Types[​](#with-funct-for-reference-types "Direct link to With Func<T> for Reference Types")
...
## Skipping Individual Test Cases[​](#skipping-individual-test-cases "Direct link to Skipping Individual Test Cases")
...
## Categorizing Test Cases[​](#categorizing-test-cases "Direct link to Categorizing Test Cases")
...
## With ClassDataSource[​](#with-classdatasource "Direct link to With ClassDataSource")
...
## Universal Data Source Support[​](#universal-data-source-support "Direct link to Universal Data Source Support")
