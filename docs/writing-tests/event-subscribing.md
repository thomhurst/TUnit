...
## Registration callbacks for executors[​](#registration-callbacks-for-executors "Direct link to Registration callbacks for executors")
...
## Execution Stage Control[​](#execution-stage-control "Direct link to Execution Stage Control")
...
### EventReceiverStage Options[​](#eventreceiverstage-options "Direct link to EventReceiverStage Options")
...
### When to Use Early Stage[​](#when-to-use-early-stage "Direct link to When to Use Early Stage")
...
### When to Use Late Stage[​](#when-to-use-late-stage "Direct link to When to Use Late Stage")
...
### Example: Early Stage Event Receiver[​](#example-early-stage-event-receiver "Direct link to Example: Early Stage Event Receiver")
...
### Example: Late Stage Event Receiver (Default)[​](#example-late-stage-event-receiver-default "Direct link to Example: Late Stage Event Receiver (Default)")
...
### .NET Framework / .NET Standard 2.0 Behavior[​](#net-framework--net-standard-20-behavior "Direct link to .NET Framework / .NET Standard 2.0 Behavior")
