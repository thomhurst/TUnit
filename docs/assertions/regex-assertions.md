...
## Group Assertions[​](#group-assertions "Direct link to Group Assertions")

The key advantage of regex assertions is the ability to assert on capture groups using `.Group()`:

### Named Groups[​](#named-groups "Direct link to Named Groups")
...
### Indexed Groups[​](#indexed-groups "Direct link to Indexed Groups")
...
## Multiple Matches[​](#multiple-matches "Direct link to Multiple Matches")
...
## Match Position and Length[​](#match-position-and-length "Direct link to Match Position and Length")
...
## Complex Patterns with Multiple Groups[​](#complex-patterns-with-multiple-groups "Direct link to Complex Patterns with Multiple Groups")
...
## Product Information Validation[​](#product-information-validation "Direct link to Product Information Validation")
...
## URL Parsing[​](#url-parsing "Direct link to URL Parsing")
...
## Regex Options[​](#regex-options "Direct link to Regex Options")
...
## Source-Generated Regex (Recommended)[​](#source-generated-regex-recommended "Direct link to Source-Generated Regex (Recommended)")
...
## Optional and Empty Groups[​](#optional-and-empty-groups "Direct link to Optional and Empty Groups")
...
## Related Assertions[​](#related-assertions "Direct link to Related Assertions")
