...
## Naming Rules[​](#naming-rules "Direct link to Naming Rules")
...
### Custom names[​](#custom-names "Direct link to Custom names")
...
## Assert.Multiple[​](#assertmultiple "Direct link to Assert.Multiple")
...
## Because[​](#because "Direct link to Because")
...
## User-defined assertions[​](#user-defined-assertions "Direct link to User-defined assertions")
...
## Analyzer support[​](#analyzer-support "Direct link to Analyzer support")
...
## FluentAssertions coexistence[​](#fluentassertions-coexistence "Direct link to FluentAssertions coexistence")
