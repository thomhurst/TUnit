...
## Creating a Custom Assertion[​](#creating-a-custom-assertion "Direct link to Creating a Custom Assertion")
...
### Step 1: Create an Assertion Class[​](#step-1-create-an-assertion-class "Direct link to Step 1: Create an Assertion Class")
...
### Step 2: Create an Extension Method[​](#step-2-create-an-extension-method "Direct link to Step 2: Create an Extension Method")
...
### Step 3: Use Your Custom Assertion[​](#step-3-use-your-custom-assertion "Direct link to Step 3: Use Your Custom Assertion")
...
## Chaining with And/Or[​](#chaining-with-andor "Direct link to Chaining with And/Or")
