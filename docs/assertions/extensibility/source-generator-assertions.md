...
## Method-Level Generation: `[GenerateAssertion]`[​](#method-level-generation-generateassertion "Direct link to method-level-generation-generateassertion")
...
## Custom Expectation Messages[​](#custom-expectation-messages "Direct link to Custom Expectation Messages")
...
### Using Parameters in Messages[​](#using-parameters-in-messages "Direct link to Using Parameters in Messages")
...
## Supported Return Types[​](#supported-return-types "Direct link to Supported Return Types")

### 1. `bool` - Simple Pass/Fail[​](#1-bool---simple-passfail "Direct link to 1-bool---simple-passfail")
...
### 3. `Task<bool>` - Async Operations[​](#3-taskbool---async-operations "Direct link to 3-taskbool---async-operations")
...
### 4. `Task<AssertionResult>` - Async with Custom Messages[​](#4-taskassertionresult---async-with-custom-messages "Direct link to 4-taskassertionresult---async-with-custom-messages")
...
## Methods with Parameters[​](#methods-with-parameters "Direct link to Methods with Parameters")
...
## Class-Level Generation: `[AssertionFrom]`[​](#class-level-generation-assertionfrom "Direct link to class-level-generation-assertionfrom")
...
### With Custom Names[​](#with-custom-names "Direct link to With Custom Names")
...
### Negation Support[​](#negation-support "Direct link to Negation Support")
...
### Referencing Methods on Different Types[​](#referencing-methods-on-different-types "Direct link to Referencing Methods on Different Types")
...
## Method Body Inlining (Advanced)[​](#method-body-inlining-advanced "Direct link to Method Body Inlining (Advanced)")
...
### Using `InlineMethodBody`[​](#using-inlinemethodbody "Direct link to using-inlinemethodbody")
...
### Benefits of Inlining[​](#benefits-of-inlining "Direct link to Benefits of Inlining")
...
### When to Use Inlining[​](#when-to-use-inlining "Direct link to When to Use Inlining")
...
## Requirements and Best Practices[​](#requirements-and-best-practices "Direct link to Requirements and Best Practices")

### Method Requirements[​](#method-requirements "Direct link to Method Requirements")
...
### Hiding Helper Methods from IntelliSense[​](#hiding-helper-methods-from-intellisense "Direct link to Hiding Helper Methods from IntelliSense")
...
### Recommended Patterns[​](#recommended-patterns "Direct link to Recommended Patterns")
...
## Chaining and Composition[​](#chaining-and-composition "Direct link to Chaining and Composition")
