...
## How to Implement Type Conversion Assertions[​](#how-to-implement-type-conversion-assertions "Direct link to How to Implement Type Conversion Assertions")

Creating a type-converting assertion involves two main steps:

### 1. Create the Assertion Class[​](#1-create-the-assertion-class "Direct link to 1. Create the Assertion Class")
...
### 2. Create the Extension Method[​](#2-create-the-extension-method "Direct link to 2. Create the Extension Method")
...
### 3. Create Assertions for the Target Type[​](#3-create-assertions-for-the-target-type "Direct link to 3. Create Assertions for the Target Type")
...
## Built-in Examples[​](#built-in-examples "Direct link to Built-in Examples")
