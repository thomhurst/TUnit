...
## How to Return Values from Assertions[​](#how-to-return-values-from-assertions "Direct link to How to Return Values from Assertions")
...
### Example: Contains with Predicate[​](#example-contains-with-predicate "Direct link to Example: Contains with Predicate")
...
### Extension Method[​](#extension-method "Direct link to Extension Method")
