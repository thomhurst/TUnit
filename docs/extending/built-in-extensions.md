...
### TRX Test Reports[​](#trx-test-reports "Direct link to TRX Test Reports")
...
## Optional Extensions[​](#optional-extensions "Direct link to Optional Extensions")

These extensions are **not** included with the TUnit package and must be installed manually if needed.

## Crash Dump[​](#crash-dump "Direct link to Crash Dump")
...
## Hang Dump[​](#hang-dump "Direct link to Hang Dump")
