...
## When to Build a TUnit Library[​](#when-to-build-a-tunit-library "Direct link to When to Build a TUnit Library")
...
## Example `.csproj` for a TUnit Library[​](#example-csproj-for-a-tunit-library "Direct link to example-csproj-for-a-tunit-library")
...
## Example Library Code[​](#example-library-code "Direct link to Example Library Code")
...
## Consuming the Library[​](#consuming-the-library "Direct link to Consuming the Library")
