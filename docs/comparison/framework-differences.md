...
## xUnit[​](#xunit "Direct link to xUnit")

### Parallel test limiting[​](#parallel-test-limiting "Direct link to Parallel test limiting")
...
### Assembly-level hooks[​](#assembly-level-hooks "Direct link to Assembly-level hooks")
...
### TestContext[​](#testcontext "Direct link to TestContext")
...
## NUnit[​](#nunit "Direct link to NUnit")

### Shared test class instances[​](#shared-test-class-instances "Direct link to Shared test class instances")
...
### Dynamic data and filtering[​](#dynamic-data-and-filtering "Direct link to Dynamic data and filtering")
...
### Assertions[​](#assertions-1 "Direct link to Assertions")
...
### Source generation, Native AOT, and single-file support[​](#source-generation-native-aot-and-single-file-support "Direct link to Source generation, Native AOT, and single-file support")
...
### Test dependencies[​](#test-dependencies "Direct link to Test dependencies")
...
### Data injection[​](#data-injection "Direct link to Data injection")
