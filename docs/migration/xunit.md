...
### Basic Test Structure[​](#basic-test-structure "Direct link to Basic Test Structure")

#### Simple Test (Fact → Test)[​](#simple-test-fact--test "Direct link to Simple Test (Fact → Test)")
...
#### Theory with InlineData → Arguments[​](#theory-with-inlinedata--arguments "Direct link to Theory with InlineData → Arguments")
...
#### MemberData → MethodDataSource[​](#memberdata--methoddatasource "Direct link to MemberData → MethodDataSource")
...
#### ClassData → MethodDataSource[​](#classdata--methoddatasource "Direct link to ClassData → MethodDataSource")
...
#### Constructor and IDisposable → Before/After Hooks[​](#constructor-and-idisposable--beforeafter-hooks "Direct link to Constructor and IDisposable → Before/After Hooks")
...
#### IAsyncLifetime → Before/After Hooks[​](#iasynclifetime--beforeafter-hooks "Direct link to IAsyncLifetime → Before/After Hooks")
...
### Shared Context and Fixtures[​](#shared-context-and-fixtures "Direct link to Shared Context and Fixtures")

#### IClassFixture → ClassDataSource[​](#iclassfixture--classdatasource "Direct link to IClassFixture → ClassDataSource")
...
#### Collection Fixtures → Shared ClassDataSource[​](#collection-fixtures--shared-classdatasource "Direct link to Collection Fixtures → Shared ClassDataSource")
...
#### Assembly Fixture → ClassDataSource with PerAssembly[​](#assembly-fixture--classdatasource-with-perassembly "Direct link to Assembly Fixture → ClassDataSource with PerAssembly")
...
#### ITestOutputHelper → TestContext[​](#itestoutputhelper--testcontext "Direct link to ITestOutputHelper → TestContext")
...
### Traits and Categories[​](#traits-and-categories "Direct link to Traits and Categories")

#### Trait → Property[​](#trait--property "Direct link to Trait → Property")
...
#### Basic Assertions[​](#basic-assertions "Direct link to Basic Assertions")
...
#### Exception Assertions[​](#exception-assertions "Direct link to Exception Assertions")
...
### Complete Example: Real-World Test Class[​](#complete-example-real-world-test-class "Direct link to Complete Example: Real-World Test Class")
