...
internal static class MockImplBuilder
{
    public static string Build(MockTypeModel model)
    {
        ...
        var mockNamespace = GetMockNamespace(model);
    ...
    private static void BuildInterfaceMockImpl(CodeWriter writer, MockTypeModel model, string safeName)
    {
        ...
        using (writer.Block($"internal sealed class {safeName}MockImpl : {baseTypes}, global::TUnit.Mocks.IRaisable, global::TUnit.Mocks.IMockObject"))
        {
    ...
    private static void BuildWrapMockImpl(CodeWriter writer, MockTypeModel model, string safeName)
    {
        ...
        using (writer.Block($"internal sealed class {safeName}WrapMockImpl : {model.FullyQualifiedName}, global::TUnit.Mocks.IRaisable, global::TUnit.Mocks.IMockObject"))
        {
            writer.AppendLine($"private readonly global::TUnit.Mocks.MockEngine<{mockableType}> _engine;");
    ...
    private static void BuildPartialMockImpl(CodeWriter writer, MockTypeModel model, string safeName)
    {
        ...
        using (writer.Block($"internal sealed class {safeName}MockImpl : {model.FullyQualifiedName}, global::TUnit.Mocks.IRaisable, global::TUnit.Mocks.IMockObject"))
        {
            writer.AppendLine($"private readonly global::TUnit.Mocks.MockEngine<{mockableType}> _engine;");
            writer.AppendLine();
