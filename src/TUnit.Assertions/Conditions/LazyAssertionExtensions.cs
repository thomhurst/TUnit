...
/// <summary>
/// Source-generated assertions for Lazy&lt;T&gt; type using [GenerateAssertion(InlineMethodBody = true)] attributes.
/// These wrap lazy initialization checks as extension methods.
/// </summary>
file static partial class LazyAssertionExtensions
{
    [GenerateAssertion(ExpectationMessage = "to have its value created", InlineMethodBody = true)]
    ...
    [GenerateAssertion(ExpectationMessage = "to not have its value created", InlineMethodBody = true)]
    [UnconditionalSuppressMessage("Trimming", "IL2091", Justification = "Only checking IsValueCreated property, not creating instances")]
