...
public static class GenericTestInvocationWriter
{
        ...
        TestSourceDataModel testSourceDataModel)
    {
        ...
        sourceBuilder.WriteLine($"var methodInfo = {MethodInfoWriter.Write(testSourceDataModel.FullyQualifiedTypeName, testSourceDataModel.MethodName, testSourceDataModel.MethodParameterTypes)};");
