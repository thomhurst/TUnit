...
public static class FailedTestInitializationWriter
{
        ...
        TestSourceDataModel testSourceDataModel)
    {
        ...
        sourceBuilder.WriteLine($"ReturnType = {MethodInfoWriter.Write(testSourceDataModel.FullyQualifiedTypeName, testSourceDataModel.MethodName, testSourceDataModel.MethodParameterTypes)}.ReturnType,");
