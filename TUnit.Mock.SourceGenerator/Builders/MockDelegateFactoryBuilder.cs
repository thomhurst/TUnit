    ...
    public static string Build(MockTypeModel model)
    {
        ...
        using (writer.Block("namespace TUnit.Mock.Generated"))
        {
            using (writer.Block($"internal static class {safeName}_MockDelegateFactory"))
            {
                ...
                {
                    writer.AppendLine($"global::TUnit.Mock.Mock.RegisterDelegateFactory<{model.FullyQualifiedName}>(Create);");
                }
                writer.AppendLine();
                ...
                using (writer.Block($"private static global::TUnit.Mock.Mock<{model.FullyQualifiedName}> Create(global::TUnit.Mock.MockBehavior behavior)"))
                {
                    ...
                    writer.AppendLine($"var mock = new global::TUnit.Mock.Mock<{model.FullyQualifiedName}>(del, setup, verify, engine);");
