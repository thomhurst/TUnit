...
public class DependsOnWithBaseTests : DependsOnBase
{
    ...
    {
        _subTypeTestStart = TestContext.Current!.Execution.Execution.TestStart!.Value.DateTime;
...
public abstract class DependsOnBase
{
    ...
    {
        BaseTestStart = TestContext.Current!.Execution.Execution.TestStart!.Value.DateTime;
