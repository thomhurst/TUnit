...
public class InjectSharedPerKey1(DummyReferenceTypeClass dummyReferenceTypeClass)
{
    public static string Key
    {
        get
        {
            ...
            return TestContext.Current.Metadata.TestDetails.MethodMetadata.Class.Namespace + "." + TestContext.Current.Metadata.TestDetails.MethodMetadata.Class.Name + "_" + TestContext.Current.Metadata.TestDetails.TestName;
        }
    }
...
{
    public static string Key => TestContext.Current!.Metadata.TestDetails.MethodMetadata.Class.Namespace + "." + TestContext.Current.Metadata.TestDetails.MethodMetadata.Class.Name + "_" + TestContext.Current.Metadata.TestDetails.TestName;
...
{
    public static string Key => TestContext.Current!.Metadata.TestDetails.MethodMetadata.Class.Namespace + "." + TestContext.Current.Metadata.TestDetails.MethodMetadata.Class.Name + "_"
