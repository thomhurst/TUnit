...
public class DependsOnTests3
{
    ...
    {
        await Assert.That(_test3Start).IsGreaterThanOrEqualTo(_test1Start.AddSeconds(1));
        await Assert.That(_test3Start).IsGreaterThanOrEqualTo(_test2Start.AddSeconds(1));
    }
}