...
public class KeyedNotInParallelTests
{
    ...
    {
        TestDateTimeRanges.Add(new ConstraintDateTimeRange(TestContext.Current!.Metadata.TestDetails.TestName, TestContext.Current.Execution.TestStart!.Value.DateTime, TestContext.Current.Result!.End!.Value.DateTime));
