...
public class DependsOnTests2
{
    ...
    {
        _test1Start = TestContext.Current!.Execution.Execution.TestStart!.Value.DateTime;
    ...
    {
        _test2Start = TestContext.Current!.Execution.Execution.TestStart!.Value.DateTime;
