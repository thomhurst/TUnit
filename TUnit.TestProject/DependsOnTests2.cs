...
public class DependsOnTests2
{
    ...
    {
        await Assert.That(() => TestContext.Current!.Dependencies.GetTests(nameof(Test1))).ThrowsException().WithMessage("Cannot get unfinished tests - Did you mean to add a [DependsOn] attribute?");
    }
