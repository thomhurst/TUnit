...
public class AsyncTaskTests
{
    ...
    {
        await TUnitAssert.That(() => Task.FromResult("Hello")).IsNotNullOrEmpty().And.Is.EqualTo("Hello");
    }
    
    [Test]
    public async Task Func_Awaited_Task_Is_Callable()
    {
        await TUnitAssert.That(async () => await Task.FromResult("Hello")).IsNotNullOrEmpty().And.Is.EqualTo("Hello");
    }
    
    [Test]
    public async Task Func_Awaited_ValueTask_Is_Callable()
    {
        await TUnitAssert.That(async () => await ValueTask.FromResult("Hello")).IsNotNullOrEmpty().And.Is.EqualTo("Hello");
    }
    
    [Test]
    public async Task ValueTask_Is_Callable()
    {
        await TUnitAssert.That(ValueTask.FromResult("Hello")).IsNotNullOrEmpty().And.Is.EqualTo("Hello");
    }
