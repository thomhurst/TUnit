...
internal static class ServiceCollectionExtensions
{
        ...
        IServiceProvider frameworkServiceProvider, IExtension extension)
    {
        return services
            ...
            .AddSingleton<TestsLoader>(x => new TestsLoader(frameworkServiceProvider.GetLoggerFactory()))
            .AddSingleton<TestsExecutor>()
            .AddSingleton<TestGrouper>()
            .AddSingleton<SingleTestExecutor>()
            .AddSingleton<TestInvoker>()
            .AddSingleton<TUnitTestDiscoverer>(x => ActivatorUtilities.CreateInstance<TUnitTestDiscoverer>(x, frameworkServiceProvider.GetLoggerFactory()))
