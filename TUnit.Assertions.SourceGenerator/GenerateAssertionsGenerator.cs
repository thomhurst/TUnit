    ...
    private static void GenerateFiles(SourceProductionContext spc,
        ...
        foreach (AssertionHolderDto holderDto in dtoArray) {
            builder.AppendAutoGenerated()
                .AppendUsings("TUnit.Assertions.Extensions", "TUnit.Assertions.AssertConditions",
                    "TUnit.Assertions.AssertConditions.Interfaces", "TUnit.Assertions.AssertionBuilders",
