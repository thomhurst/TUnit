...
internal class ConflictingNamespaceTests : TestsBase
{
    ...
    public Task BasicTest_WithConflictingNamespace() => RunTest(
        Path.Combine(Git.TestsDirectory.FullName, "TUnit.TestProject", "BasicTests.cs"),
        new RunTestOptions
        {
            AdditionalSyntaxes =
            [
    ...
    public Task DataDrivenTest_WithConflictingNamespace() => RunTest(
        Path.Combine(Git.TestsDirectory.FullName, "TUnit.TestProject", "DataDrivenTests.cs"),
        new RunTestOptions
        {
            AdditionalFiles =
            [
                Path.Combine(Git.TestsDirectory.FullName, "TUnit.TestProject", "TestEnum.cs")
            ],
            AdditionalSyntaxes =
            [
    ...
    public Task HooksTest_WithConflictingNamespace() => HooksGenerator.RunTest(
        Path.Combine(Git.TestsDirectory.FullName, "TUnit.TestProject", "BeforeTests", "BeforeTests.cs"),
        new RunTestOptions
        {
            AdditionalSyntaxes =
            [
    ...
    public Task MethodDataSource_WithConflictingNamespace() => RunTest(
        Path.Combine(Git.TestsDirectory.FullName, "TUnit.TestProject", "MethodDataSourceDrivenTests.cs"),
        new RunTestOptions
        {
            AdditionalSyntaxes =
            [
    ...
    public Task MatrixTest_WithConflictingNamespace() => RunTest(
        Path.Combine(Git.TestsDirectory.FullName, "TUnit.TestProject", "MatrixTests.cs"),
        new RunTestOptions
        {
            AdditionalSyntaxes =
            [
    ...
    public Task TupleDataSource_WithConflictingNamespace() => RunTest(
        Path.Combine(Git.TestsDirectory.FullName, "TUnit.TestProject", "TupleDataSourceDrivenTests.cs"),
        new RunTestOptions
        {
            AdditionalSyntaxes =
            [
