...
internal class Tests1899 : TestsBase
{
    ...
    public Task Test() => RunTest(Path.Combine(Git.TestsDirectory.FullName,
        ...
        new RunTestOptions
        {
            AdditionalFiles =
            [
                Path.Combine(Git.TestsDirectory.FullName, "TUnit.TestProject.Library", "Bugs", "1899", "BaseClass.cs")
            ],
    ...
    [Test]
    public Task BaseClass() => RunTest(Path.Combine(Git.TestsDirectory.FullName,
