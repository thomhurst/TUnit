...
public class TestsBase<TGenerator> where TGenerator : IIncrementalGenerator, new()
{
    ...
    public async Task RunTest(string inputFile, RunTestOptions runTestOptions, Func<string[], Task> assertions)
    {
        ...
        var customAttributes = Git.TestsDirectory
        ...
        [
            // WARNING: these injected global usings (notably System.Linq) mean snapshot tests will
            // NOT catch CS1061-style "missing using" bugs in generated code — generated output is
            // compiled here with these usings always in scope. Generated code must therefore use
            // fully-qualified static calls (e.g. global::System.Linq.Enumerable.ToArray) rather than
            // extension-method chains. See ParamsArrayCompilationTests for a compile check without them.
            """
            // <auto-generated/>
