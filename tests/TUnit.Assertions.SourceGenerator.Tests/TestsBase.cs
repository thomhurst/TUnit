...
using TUnit.Assertions.SourceGenerator.Tests.Extensions;
...
public class TestsBase
{
    ...
    public TestsBase<AssertionMethodGenerator> AssertionMethodGenerator = new();

    public Task RunTest(string inputFile, Func<string[], Task> assertions)
    {
        return AssertionMethodGenerator.RunTest(inputFile, new RunTestOptions(), assertions);
    }

    public Task RunTest(string inputFile, RunTestOptions runTestOptions, Func<string[], Task> assertions)
    {
        return AssertionMethodGenerator.RunTest(inputFile, runTestOptions, assertions);
    }
}
