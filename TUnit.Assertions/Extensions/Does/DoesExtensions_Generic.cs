...
public static partial class DoesExtensions
{
    ...
    {
        return new EnumerableContainsAssertCondition<TActual, TInner, TAnd, TOr>(valueSource.AssertionBuilder.AppendCallerMethod(doNotPopulateThisValue), expected, equalityComparer)
