...
{
    public static TOutput DoesNotContain<TAssertionBuilder, TOutput, TActual, TInner, TAnd, TOr>(this TAssertionBuilder assertionBuilder, TInner expected, IEqualityComparer<TInner?>? equalityComparer = null, [CallerArgumentExpression("expected")] string doNotPopulateThisValue = "")
