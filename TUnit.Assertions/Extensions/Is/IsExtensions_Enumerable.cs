...
{
    public static BaseAssertCondition<TActual, TAnd, TOr> EquivalentTo<TActual, TInner, TAnd, TOr>(this Is<TActual, TAnd, TOr> @is, IEnumerable<TInner> expected, IEqualityComparer<TInner> equalityComparer, [CallerArgumentExpression("expected")] string doNotPopulateThisValue = "")
