...
{
    public AssertionBuilder<string> EqualTo(int expected, [CallerArgumentExpression(nameof(expected))] string? doNotPopulateThisValue = null)
    {
    ...
    public AssertionBuilder<string> Zero =>
    ...
    public AssertionBuilder<string> Positive =>
    ...
    public AssertionBuilder<string> GreaterThan(int expected, [CallerArgumentExpression(nameof(expected))] string? doNotPopulateThisValue = null)
    {
    ...
    public AssertionBuilder<string> GreaterThanOrEqualTo(int expected, [CallerArgumentExpression(nameof(expected))] string? doNotPopulateThisValue = null)
    {
    ...
    public AssertionBuilder<string> LessThan(int expected, [CallerArgumentExpression(nameof(expected))] string? doNotPopulateThisValue = null)
    {
        return valueSource.RegisterAssertion(new FuncValueAssertCondition<string, int>(expected, (@string, _, self) =>
            {
                if (@string is null)
    ...
    public AssertionBuilder<string> LessThanOrEqualTo(int expected, [CallerArgumentExpression(nameof(expected))] string? doNotPopulateThisValue = null)
    {
        return valueSource.RegisterAssertion(new FuncValueAssertCondition<string, int>(expected, (@string, _, self) =>
            {
                if (@string is null)
