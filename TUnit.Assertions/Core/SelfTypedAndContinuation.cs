...
/// <summary>
/// Represents an And continuation that preserves the source assertion type.
/// Enables instance methods from TSelf to remain available after .And.
/// </summary>
...
public class SelfTypedAndContinuation<TValue, TSelf> : IAssertionSource<TValue>
    where TSelf : SelfTypedAssertion<TValue, TSelf>
{
    ...
    internal SelfTypedAndContinuation(AssertionContext<TValue> context, TSelf previousAssertion)
    {
