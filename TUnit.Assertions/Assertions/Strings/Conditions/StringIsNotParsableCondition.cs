...
public class StringIsNotParsableCondition<
...
{
    public StringIsNotParsableCondition(IFormatProvider? formatProvider = null) 
        : base(formatProvider)
    {
    }

    protected internal override string GetExpectation() => $"not to be parsable into {typeof(TTarget).Name}";
    ...
    protected override ValueTask<AssertionResult> GetResult(string? actualValue, IFormatProvider? formatProvider)
    {
        ...
        if (targetType.GetInterfaces().Any(i => i == iParsableType))
        {
            ...
            if (tryParseMethod != null)
            {
                ...
                if (success)
                {
                    ...
                    return new ValueTask<AssertionResult>(AssertionResult.FailIf(true, 
                        $"parsing succeeded with value: {parsedValue}"));
                }
                return new ValueTask<AssertionResult>(AssertionResult.Passed);
            }
        }
        ...
        if (traditionalTryParse != null)
        {
            ...
            {
                parsedValue = parameters[^1];
                return new ValueTask<AssertionResult>(AssertionResult.FailIf(true, $"parsing succeeded with value: {parsedValue}"));
            }
            return new ValueTask<AssertionResult>(AssertionResult.Passed);
        }
        ...
        if (formatProvider != null)
        {
            ...
            if (tryParseWithProvider != null)
            {
                ...
                {
                    parsedValue = parameters[^1];
                    return AssertionResult.FailIf(true, $"parsing succeeded with value: {parsedValue}");
                }
                return new ValueTask<AssertionResult>(AssertionResult.Passed);
            }
        ...
        // If type doesn't support parsing, that's considered "not parsable" - pass
        return new ValueTask<AssertionResult>(AssertionResult.Passed);
    }
}