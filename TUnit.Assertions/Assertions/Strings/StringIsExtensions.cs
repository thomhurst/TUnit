...
public static class StringIsExtensions
{
    ...
    public static InvokableValueAssertion<string> IsEmpty(this IValueSource<string> valueSource)
    {
    ...
    public static InvokableValueAssertion<string> IsNullOrEmpty(this IValueSource<string> valueSource)
    {
        return valueSource.RegisterAssertion(new FuncValueAssertCondition<string, int>(0,
    ...
    public static InvokableValueAssertion<string> IsNullOrWhitespace(this IValueSource<string> valueSource)
    {
        return valueSource.RegisterAssertion(new FuncValueAssertCondition<string, int>(0,
