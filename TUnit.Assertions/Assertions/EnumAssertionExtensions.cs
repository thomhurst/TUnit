...
public static partial class EnumAssertionExtensions
{
    ...
    public static InvokableValueAssertion<TEnum> IsDefined<TEnum>(this IValueSource<TEnum> valueSource)
        where TEnum : struct, Enum
    {
        return valueSource.RegisterAssertion(new EnumIsDefinedAssertCondition<TEnum>(), []);
    }

    public static InvokableValueAssertion<TEnum> IsNotDefined<TEnum>(this IValueSource<TEnum> valueSource)
        where TEnum : struct, Enum
    {
