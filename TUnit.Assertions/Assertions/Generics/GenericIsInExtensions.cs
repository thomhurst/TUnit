...
{
    public static InvokableValueAssertion<TActual> IsIn<TActual>(this IValueSource<TActual> valueSource, params TActual[] expected)
    {
        return IsIn(valueSource, expected, EqualityComparer<TActual>.Default);
    }

    public static InvokableValueAssertion<TActual> IsIn<TActual>(this IValueSource<TActual> valueSource, IEnumerable<TActual> expected)
    {
        return IsIn(valueSource, expected, EqualityComparer<TActual>.Default);
    }

    public static InvokableValueAssertion<TActual> IsIn<TActual>(this IValueSource<TActual> valueSource, IEnumerable<TActual> expected, IEqualityComparer<TActual> equalityComparer)
    {
