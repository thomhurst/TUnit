...
public static class NumberIsNotExtensions
{
    ...
    public static InvokableValueAssertion<TActual> IsNotZero<TActual>(this IValueSource<TActual> valueSource)
        where TActual : INumber<TActual>
    {
    ...
    public static InvokableValueAssertion<TActual> IsNotDivisibleBy<TActual>(
    ...
    public static InvokableValueAssertion<TActual> IsNotGreaterThan<TActual>(this IValueSource<TActual> valueSource, TActual expected, [CallerArgumentExpression(nameof(expected))] string doNotPopulateThisValue = null) where TActual : INumber<TActual>
    {
        return valueSource.RegisterAssertion(new FuncValueAssertCondition<TActual, TActual>(default(TActual), (value, _, self) =>
            {
                if (value is null)
    ...
    public static InvokableValueAssertion<TActual> IsNotGreaterThanOrEqualTo<TActual>(this IValueSource<TActual> valueSource, TActual expected, [CallerArgumentExpression(nameof(expected))] string doNotPopulateThisValue = null) 
        where TActual : INumber<TActual>
    {
        return valueSource.RegisterAssertion(new FuncValueAssertCondition<TActual, TActual>(default(TActual), (value, _, self) =>
            {
    ...
    public static InvokableValueAssertion<TActual> IsNotLessThan<TActual>(this IValueSource<TActual> valueSource, TActual expected, [CallerArgumentExpression(nameof(expected))] string doNotPopulateThisValue = null) 
        where TActual : INumber<TActual>
    {
        return valueSource.RegisterAssertion(new FuncValueAssertCondition<TActual, TActual>(default(TActual), (value, _, self) =>
            {
    ...
    public static InvokableValueAssertion<TActual> IsNotLessThanOrEqualTo<TActual>(this IValueSource<TActual> valueSource, TActual expected, [CallerArgumentExpression(nameof(expected))] string doNotPopulateThisValue = null) 
        where TActual : INumber<TActual>
    {
        return valueSource.RegisterAssertion(new FuncValueAssertCondition<TActual, TActual>(default(TActual), (value, _, self) =>
            {
    ...
    public static InvokableValueAssertion<TActual> IsNotEven<TActual>(this IValueSource<TActual> valueSource) 
    ...
    public static InvokableValueAssertion<TActual> IsNotOdd<TActual>(this IValueSource<TActual> valueSource) 
        where TActual : INumber<TActual>, IModulusOperators<TActual, int, int>
    {
        return valueSource.RegisterAssertion(new FuncValueAssertCondition<TActual, TActual>(default(TActual), (value, _, self) =>
            {
    ...
    public static InvokableValueAssertion<TActual> IsNotNegative<TActual>(this IValueSource<TActual> valueSource) 
        where TActual : INumber<TActual>
    {
        return valueSource.RegisterAssertion(new FuncValueAssertCondition<TActual, TActual>(default(TActual), (value, _, self) =>
            {
    ...
    public static InvokableValueAssertion<TActual> IsNotPositive<TActual>(this IValueSource<TActual> valueSource) 
        where TActual : INumber<TActual>
    {
        return valueSource.RegisterAssertion(new FuncValueAssertCondition<TActual, TActual>(default(TActual), (value, _, self) =>
            {
