...
{
    public static AssertionBuilder<ImmutableArray<TInner>> IsNotEquivalentTo<
    ...
    public static AssertionBuilder<ImmutableArray<TInner>> IsNotEquivalentTo<TInner>(this IValueSource<ImmutableArray<TInner>> valueSource,
    ...
    public static AssertionBuilder<ImmutableArray<TInner>> IsNotEmpty<TInner>(this IValueSource<ImmutableArray<TInner>> valueSource)
    {
