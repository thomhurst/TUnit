...
{
    public static InvokableValueAssertion<ImmutableArray<TInner>> IsNotEquivalentTo<
    ...
    public static InvokableValueAssertion<ImmutableArray<TInner>> IsNotEquivalentTo<TInner>(this IValueSource<ImmutableArray<TInner>> valueSource,
    ...
    public static InvokableValueAssertion<ImmutableArray<TInner>> IsNotEmpty<TInner>(this IValueSource<ImmutableArray<TInner>> valueSource)
    {
