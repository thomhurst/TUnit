...
{
    public static AssertionBuilder<ImmutableArray<TInner>> IsEquivalentTo<
    ...
    public static AssertionBuilder<ImmutableArray<TInner>> IsEquivalentTo<TInner>(this IValueSource<ImmutableArray<TInner>> valueSource, ImmutableArray<TInner> expected, IEqualityComparer<TInner> comparer, CollectionOrdering collectionOrdering, [CallerArgumentExpression(nameof(expected))] string doNotPopulateThisValue = null)
    {
    ...
    public static AssertionBuilder<ImmutableArray<TInner>> IsInOrder<TInner>(
            this IValueSource<ImmutableArray<TInner>> valueSource)
    {
        return IsOrderedBy(valueSource, x => x, Comparer<TInner>.Default, null);
    }

    public static AssertionBuilder<ImmutableArray<TInner>> IsInDescendingOrder<TInner>(
        this IValueSource<ImmutableArray<TInner>> valueSource)
    {
    ...
    public static AssertionBuilder<ImmutableArray<TInner>> IsOrderedBy<TInner, TComparisonItem>(
        this IValueSource<ImmutableArray<TInner>> valueSource,
    ...
    public static AssertionBuilder<ImmutableArray<TInner>> IsOrderedByDescending<TInner, TComparisonItem>(
        this IValueSource<ImmutableArray<TInner>> valueSource,
        Func<TInner, TComparisonItem> comparisonItemSelector,
        [CallerArgumentExpression(nameof(comparisonItemSelector))] string doNotPopulateThisValue = null)
    {
    ...
    public static AssertionBuilder<ImmutableArray<TInner>> IsEmpty<TInner>(this IValueSource<ImmutableArray<TInner>> valueSource)
    {
