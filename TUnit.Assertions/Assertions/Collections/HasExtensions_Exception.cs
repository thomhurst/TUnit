...
{
    public static InvokableValueAssertionBuilder<TActual> HasMessageEqualTo<TActual>(this IValueSource<TActual> valueSource, string expected, [CallerArgumentExpression(nameof(expected))] string doNotPopulateThisValue = null) where TActual : Exception
    {
    ...
    public static InvokableValueAssertionBuilder<TActual> HasMessageContaining<TActual>(this IValueSource<TActual> valueSource, string expected, [CallerArgumentExpression(nameof(expected))] string doNotPopulateThisValue = null) where TActual : Exception
    {
    ...
    public static InvokableValueAssertionBuilder<TActual> HasMessageStartingWith<TActual>(this IValueSource<TActual> valueSource, string expected, [CallerArgumentExpression(nameof(expected))] string doNotPopulateThisValue = null) where TActual : Exception
    {
    ...
    public static InvokableValueAssertionBuilder<TActual> HasMessageEndingWith<TActual>(this IValueSource<TActual> valueSource, string expected, [CallerArgumentExpression(nameof(expected))] string doNotPopulateThisValue = null) where TActual : Exception
    {
