...
{
    public static AssertionBuilder<TActual> IsEquivalentTo<TActual,
    ...
    public static AssertionBuilder<TActual> IsEquivalentTo<
        TActual,
    ...
    public static AssertionBuilder<IEnumerable<TInner>> IsInOrder<TInner>(
            this IValueSource<IEnumerable<TInner>> valueSource)
    {
        return IsOrderedBy(valueSource, x => x, Comparer<TInner>.Default, null);
    }

    public static AssertionBuilder<IEnumerable<TInner>> IsInDescendingOrder<TInner>(
        this IValueSource<IEnumerable<TInner>> valueSource)
    {
    ...
    public static AssertionBuilder<IEnumerable<TInner>> IsOrderedBy<TInner, TComparisonItem>(
        this IValueSource<IEnumerable<TInner>> valueSource,
    ...
    public static AssertionBuilder<IEnumerable<TInner>> IsOrderedByDescending<TInner, TComparisonItem>(
        this IValueSource<IEnumerable<TInner>> valueSource,
        Func<TInner, TComparisonItem> comparisonItemSelector,
        [CallerArgumentExpression(nameof(comparisonItemSelector))] string doNotPopulateThisValue = null)
    {
    ...
    public static AssertionBuilder<IEnumerable<TInner>> IsEmpty<TInner>(this IValueSource<IEnumerable<TInner>> valueSource)
    {
