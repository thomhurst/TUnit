    ...
    where TActual : IEnumerable<TInner?>
{
    ...
    private readonly Func<IValueSource<TExpected?>, AssertionBuilder> _assertionBuilder;
    ...
    public EnumerableSatisfiesAssertCondition(Func<TInner?, Task<TExpected>?> mapper,
        Func<IValueSource<TExpected?>, AssertionBuilder> assertionBuilder, string mapperExpression, string assertionBuilderExpression)
    {
        _mapper = mapper;
