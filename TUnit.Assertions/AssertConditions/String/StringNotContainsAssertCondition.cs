    ...
    where TOr : Or<string, TAnd, TOr>, IOr<TOr, string, TAnd, TOr>
{
    ...
    public StringNotContainsAssertCondition(AssertionBuilder<string> assertionBuilder, string expected, StringComparison stringComparison) : base(assertionBuilder, expected)
    {
