...
public class RunAssertionsCodeFixersTestsModule : Module<CommandResult>
{
    protected override async Task<CommandResult?> ExecuteAsync(IPipelineContext context, CancellationToken cancellationToken)
    {
        ...
        return await context.DotNet().Test(new DotNetTestOptions(project)
        {
            ...
            Framework = "net8.0",
            Arguments = ["--", "--hangdump", "--hangdump-filename", "hangdump.assertions-codefixers-tests.dmp", "--hangdump-timeout", "20m"],
