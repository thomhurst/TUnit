...
public class RunAssertionsShouldTestsModule : TestBaseModule
{
    ...
    {
        var project = context.Git().RootDirectory.FindFile(x => x.Name == "TUnit.Assertions.Should.Tests.csproj").AssertExists();
