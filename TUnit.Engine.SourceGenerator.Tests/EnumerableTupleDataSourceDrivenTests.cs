...
internal class EnumerableTupleDataSourceDrivenTests : TestsBase<TestsGenerator>
{
    ...
    public Task Test() => RunTest(Path.Combine(Git.RootDirectory.FullName,
        ...
        generatedFiles =>
        {
            ...
            Assert.That(generatedFiles[1], Does.Contain("TestMethodFactory = (classInstance, cancellationToken) => AsyncConvert.Convert(() => classInstance.DataSource_TupleMethod(methodArg1, methodArg2, methodArg3))"));
        });
}