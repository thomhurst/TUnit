...
internal class STAThreadHooksTests : TestsBase<TestHooksGenerator>
{
    ...
    public Task Test() => RunTest(Path.Combine(Git.RootDirectory.FullName,
        ...
        generatedFiles =>
        {
            ...
            Assert.That(generatedFiles[0], Does.Contain("TestHookOrchestrator.RegisterSetUp"));
            Assert.That(generatedFiles[0], Does.Contain("HookExecutor = new global::TUnit.Core.STAThreadExecutor(),"));
            
            Assert.That(generatedFiles[1], Does.Contain("TestHookOrchestrator.RegisterCleanUp"));
