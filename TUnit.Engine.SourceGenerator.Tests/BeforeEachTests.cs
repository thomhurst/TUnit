    ...
    public Task Test() => RunTest(Path.Combine(Git.RootDirectory.FullName,
        ...
        generatedFiles =>
        {
            ...
            Assert.That(generatedFiles[1].IgnoreWhitespaceFormatting(), Does.Contain(
	            """
	            TestHookOrchestrator.RegisterSetUp<global::TUnit.TestProject.BeforeTests.Base1>(new InstanceHookMethod<global::TUnit.TestProject.BeforeTests.Base1>
	            { 
            ...
            Assert.That(generatedFiles[3].IgnoreWhitespaceFormatting(), Does.Contain(
	            """
	            TestHookOrchestrator.RegisterSetUp<global::TUnit.TestProject.BeforeTests.Base2>(new InstanceHookMethod<global::TUnit.TestProject.BeforeTests.Base2>
	            { 
            ...
            Assert.That(generatedFiles[5].IgnoreWhitespaceFormatting(), Does.Contain(
	            """
	            TestHookOrchestrator.RegisterSetUp<global::TUnit.TestProject.BeforeTests.Base3>(new InstanceHookMethod<global::TUnit.TestProject.BeforeTests.Base3>
	            { 
            ...
            Assert.That(generatedFiles[10].IgnoreWhitespaceFormatting(), Does.Contain(
	            """
		            TestHookOrchestrator.RegisterSetUp<global::TUnit.TestProject.BeforeTests.SetupTests>(new InstanceHookMethod<global::TUnit.TestProject.BeforeTests.SetupTests>
		            { 
