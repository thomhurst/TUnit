...
internal class PropertySetterTests : TestsBase<TestsGenerator>
{
    ...
    public Task Test() => RunTest(Path.Combine(Git.RootDirectory.FullName,
        ...
        async generatedFiles =>
        {
            ...
            await AssertFileContains(generatedFiles[0], "var propertyArg2 = testClassType.GetProperty(\"Property3\", BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.FlattenHierarchy).GetCustomAttributes<global::TUnit.Core.ClassDataSourceAttribute<global::TUnit.TestProject.PropertySetterTests.InnerModel>>(true).ElementAt(0).GenerateDataSources(new DataGeneratorMetadata\n{\n   Type = TUnit.Core.Enums.DataGeneratorType.Property,\n   TestClassType = testClassType,\n   ParameterInfos = null,\n   PropertyInfo = testClassType.GetProperty(\"Property3\", BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.FlattenHierarchy),\n   TestObjectBag = objectBag,\n}).ElementAtOrDefault(0);");
            await AssertFileContains(generatedFiles[0], "var propertyArg3 = testClassType.GetProperty(\"Property4\", BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.FlattenHierarchy).GetCustomAttributes<global::TUnit.Core.ClassDataSourceAttribute<global::TUnit.TestProject.PropertySetterTests.InnerModel>>(true).ElementAt(0).GenerateDataSources(new DataGeneratorMetadata\n{\n   Type = TUnit.Core.Enums.DataGeneratorType.Property,\n   TestClassType = testClassType,\n   ParameterInfos = null,\n   PropertyInfo = testClassType.GetProperty(\"Property4\", BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.FlattenHierarchy),\n   TestObjectBag = objectBag,\n}).ElementAtOrDefault(0);");
