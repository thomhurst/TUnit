...
internal class DataSourceGeneratorTests : TestsBase<TestsGenerator>
{
    ...
    public Task Test() => RunTest(Path.Combine(Git.RootDirectory.FullName,
        ...
        async generatedFiles =>
        {
            ...
            await AssertFileContains(generatedFiles[0], "var methodArgGeneratedDataArray = methodInfo.GetCustomAttributes<global::TUnit.TestProject.DataSourceGeneratorTests.AutoFixtureGeneratorAttribute<global::System.Int32>>(true).ElementAt(0).GenerateDataSources(new DataGeneratorMetadata\n{\n   Type = TUnit.Core.Enums.DataGeneratorType.Parameters,\n   ParameterInfos = methodInfo.GetParameters(),\n   PropertyInfo = null\n});");
            ...
            await AssertFileContains(generatedFiles[2], "var methodArgGeneratedDataArray = methodInfo.GetCustomAttributes<global::TUnit.TestProject.DataSourceGeneratorTests.AutoFixtureGeneratorAttribute<global::System.Int32, global::System.String, global::System.Boolean>>(true).ElementAt(0).GenerateDataSources(new DataGeneratorMetadata\n{\n   Type = TUnit.Core.Enums.DataGeneratorType.Parameters,\n   ParameterInfos = methodInfo.GetParameters(),\n   PropertyInfo = null\n});");
            ...
            await AssertFileContains(generatedFiles[4], "var methodArgGeneratedDataArray = methodInfo.GetCustomAttributes<global::TUnit.TestProject.DataSourceGeneratorTests.AutoFixtureGeneratorAttribute>(true).ElementAt(0).GenerateDataSources(new DataGeneratorMetadata\n{\n   Type = TUnit.Core.Enums.DataGeneratorType.Parameters,\n   ParameterInfos = methodInfo.GetParameters(),\n   PropertyInfo = null\n});");
