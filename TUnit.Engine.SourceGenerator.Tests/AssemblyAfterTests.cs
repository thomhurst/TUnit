    ...
    public Task Test() => RunTest(Path.Combine(Git.RootDirectory.FullName,
        ...
        generatedFiles =>
        {
            ...
            Assert.That(generatedFiles[0].IgnoreWhitespaceFormatting(), Does.Contain(
	            """
	            AssemblyHookOrchestrator.RegisterCleanUp(typeof(global::TUnit.TestProject.AfterTests.AssemblyBase1).Assembly, new StaticMethod<AssemblyHookContext>
	            { 
            ...
            Assert.That(generatedFiles[2].IgnoreWhitespaceFormatting(), Does.Contain(
	            """
	            AssemblyHookOrchestrator.RegisterCleanUp(typeof(global::TUnit.TestProject.AfterTests.AssemblyBase2).Assembly, new StaticMethod<AssemblyHookContext>
	            { 
            ...
            Assert.That(generatedFiles[4].IgnoreWhitespaceFormatting(), Does.Contain(
	            """
	            AssemblyHookOrchestrator.RegisterCleanUp(typeof(global::TUnit.TestProject.AfterTests.AssemblyBase3).Assembly, new StaticMethod<AssemblyHookContext>
	            { 
            ...
            Assert.That(generatedFiles[6].IgnoreWhitespaceFormatting(), Does.Contain(
	            """
		            		AssemblyHookOrchestrator.RegisterCleanUp(typeof(global::TUnit.TestProject.AfterTests.AssemblyCleanupTests).Assembly, new StaticMethod<AssemblyHookContext>
		            		{ 
