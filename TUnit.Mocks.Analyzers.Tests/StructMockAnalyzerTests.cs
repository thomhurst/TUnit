...
using Verifier = TUnit.Mocks.Analyzers.Tests.Verifiers.CSharpAnalyzerVerifier<TUnit.Mocks.Analyzers.StructMockAnalyzer>;
    ...
    public async Task Struct_Reports_TM002()
    {
        await Verifier.VerifyAnalyzerAsync(
            ...
            public class TestClass
            {
                public void Test()
                {
                    {|#0:TUnit.Mocks.Mock.Of<MyStruct>()|};
                }
            }
            """,
    ...
    public async Task Struct_With_Behavior_Reports_TM002()
    {
        await Verifier.VerifyAnalyzerAsync(
            ...
            public class TestClass
            {
                public void Test()
                {
                    {|#0:TUnit.Mocks.Mock.Of<MyStruct>(0)|};
                }
            }
            """,
            Verifier.Diagnostic(Rules.TM002_CannotMockValueType)
