...
public static class AfterEachTestRetriever
{
        ...
        foreach (var oneTimeSetUpMethod in cleanUp)
        {
            stringBuilder.Append($$"""
                                   				    ...
                                   				    new InstanceMethod<{{fullyQualifiedType}}>
                                   				    {
                                       				    ...
                                       				    Body = (classInstance, testContext, cancellationToken) => AsyncConvert.Convert(() => classInstance.{{oneTimeSetUpMethod.Name}}({{GetArgs(oneTimeSetUpMethod)}})),
                                   				    },
                                   """);
        }
