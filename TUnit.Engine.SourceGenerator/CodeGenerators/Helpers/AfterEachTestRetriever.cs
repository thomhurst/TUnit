        ...
        foreach (var oneTimeSetUpMethod in cleanUp)
        {
            stringBuilder.Append($$"""
                                   				    ...
                                   				    new InstanceMethod<{{fullyQualifiedType}}>
                                   				    {
                                       				    ...
                                       				    Body = (classInstance, cancellationToken) => RunHelpers.RunWithTimeoutAsync(() => classInstance.{{oneTimeSetUpMethod.Name}}({{GetArgs(oneTimeSetUpMethod)}}), cancellationToken),
                                   				    },
                                   """);
        }
