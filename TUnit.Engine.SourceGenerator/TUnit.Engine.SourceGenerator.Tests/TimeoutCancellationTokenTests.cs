...
internal class TimeoutCancellationTokenTests : TestsBase<TestsGenerator>
{
    ...
    public Task Test() => RunTest(Path.Combine(Git.RootDirectory.FullName,
        ...
        generatedFiles =>
        {
            ...
            Assert.That(generatedFiles[0], Does.Contain("global::TUnit.Engine.TimedCancellationToken methodArg0 = global::TUnit.Engine.EngineCancellationToken.CreateToken(attributes.OfType<global::TUnit.Core.TimeoutAttribute>().First().Timeout);"));
            ...
            Assert.That(generatedFiles[1], Does.Contain("global::TUnit.Engine.TimedCancellationToken methodArg0 = global::TUnit.Engine.EngineCancellationToken.CreateToken(attributes.OfType<global::TUnit.Core.TimeoutAttribute>().First().Timeout);"));
            ...
            Assert.That(generatedFiles[2], Does.Contain("global::TUnit.Engine.TimedCancellationToken methodArg1 = global::TUnit.Engine.EngineCancellationToken.CreateToken(attributes.OfType<global::TUnit.Core.TimeoutAttribute>().First().Timeout);"));
            ...
            Assert.That(generatedFiles[4], Does.Contain("global::TUnit.Engine.TimedCancellationToken methodArg1 = global::TUnit.Engine.EngineCancellationToken.CreateToken(attributes.OfType<global::TUnit.Core.TimeoutAttribute>().First().Timeout);"));
            ...
            Assert.That(generatedFiles[5], Does.Contain("global::TUnit.Engine.TimedCancellationToken methodArg1 = global::TUnit.Engine.EngineCancellationToken.CreateToken(attributes.OfType<global::TUnit.Core.TimeoutAttribute>().First().Timeout);"));
            ...
            Assert.That(generatedFiles[6], Does.Contain("global::TUnit.Engine.TimedCancellationToken methodArg1 = global::TUnit.Engine.EngineCancellationToken.CreateToken(attributes.OfType<global::TUnit.Core.TimeoutAttribute>().First().Timeout);"));
