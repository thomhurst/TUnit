...
internal class ClassDataSourceDrivenTests : TestsBase<TestsGenerator>
{
    ...
    public Task Shared_Argument_Is_ForClass() => RunTest(Path.Combine(Git.RootDirectory.FullName,
        ...
        generatedFiles =>
        {
            ...
            Assert.That(generatedFiles[0], Does.Contain("global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_ForClass.SomeClass methodArg0 = (global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_ForClass.SomeClass)global::TUnit.Engine.Data.TestDataContainer.InjectedSharedPerClassType.GetOrAdd(new global::TUnit.Engine.Models.DictionaryTypeTypeKey(typeof(global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_ForClass), typeof(global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_ForClass.SomeClass)), x => new global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_ForClass.SomeClass());"));
            Assert.That(generatedFiles[0], Does.Contain("classInstance.DataSource_Class(methodArg0)"));
            
            Assert.That(generatedFiles[1], Does.Contain("global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_ForClass.SomeClass methodArg0 = (global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_ForClass.SomeClass)global::TUnit.Engine.Data.TestDataContainer.InjectedSharedPerClassType.GetOrAdd(new global::TUnit.Engine.Models.DictionaryTypeTypeKey(typeof(global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_ForClass), typeof(global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_ForClass.SomeClass)), x => new global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_ForClass.SomeClass());"));
            Assert.That(generatedFiles[1], Does.Contain("classInstance.DataSource_Class_Generic(methodArg0)"));
        });
    ...
    public Task Shared_Argument_Is_Keyed() => RunTest(Path.Combine(Git.RootDirectory.FullName,
        ...
        generatedFiles =>
        {
            ...
            Assert.That(generatedFiles[0], Does.Contain("global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_Keyed.SomeClass methodArg0 = (global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_Keyed.SomeClass)global::TUnit.Engine.Data.TestDataContainer.InjectedSharedPerKey.GetOrAdd(new global::TUnit.Engine.Models.DictionaryStringTypeKey(\"🔑\", typeof(global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_Keyed.SomeClass)), x => new global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_Keyed.SomeClass());"));
            Assert.That(generatedFiles[0], Does.Contain("classInstance.DataSource_Class(methodArg0)"));
            
            Assert.That(generatedFiles[1], Does.Contain("global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_Keyed.SomeClass methodArg0 = (global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_Keyed.SomeClass)global::TUnit.Engine.Data.TestDataContainer.InjectedSharedPerKey.GetOrAdd(new global::TUnit.Engine.Models.DictionaryStringTypeKey(\"🔑\", typeof(global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_Keyed.SomeClass)), x => new global::TUnit.TestProject.ClassDataSourceDrivenTests_Shared_Keyed.SomeClass());"));
            Assert.That(generatedFiles[1], Does.Contain("classInstance.DataSource_Class_Generic(methodArg0)"));
        });
}