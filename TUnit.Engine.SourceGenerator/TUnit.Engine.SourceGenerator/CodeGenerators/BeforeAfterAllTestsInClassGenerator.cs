...
[Generator]
public class BeforeAfterAllTestsInClassGenerator : IIncrementalGenerator
{
    ...
    private void Execute(SourceProductionContext context, ImmutableArray<IMethodSymbol?> methodSymbols)
    {
        foreach (var method in methodSymbols.OfType<IMethodSymbol>())
        {
                    ...
                    == WellKnownFullyQualifiedClassNames.BeforeAllTestsInClassAttribute))
            {
                ...
                sourceBuilder.WriteLine($"global::TUnit.Engine.ClassHookOrchestrator.RegisterSetUp(typeof({classContainingMethod}), () => global::TUnit.Core.Helpers.RunHelpers.RunAsync(() => {method.ContainingType.ToDisplayString(DisplayFormats.FullyQualifiedGenericWithGlobalPrefix)}.{method.Name}()));");
                    ...
                    == WellKnownFullyQualifiedClassNames.AfterAllTestsInClassAttribute))
            {
                ...
                sourceBuilder.WriteLine($"global::TUnit.Engine.ClassHookOrchestrator.RegisterCleanUp(typeof({classContainingMethod}), () => global::TUnit.Core.Helpers.RunHelpers.RunAsync(() => {method.ContainingType.ToDisplayString(DisplayFormats.FullyQualifiedGenericWithGlobalPrefix)}.{method.Name}()));");
