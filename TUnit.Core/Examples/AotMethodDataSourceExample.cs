...
public static class GeneratedAotMethodDataSourceExample
{
    ...
    public static void RegisterFactories()
    {
        ...
        TestExecutionRegistry.Instance.RegisterMethodDataResolver("MyTests.MyTest", MyTests_MyTest_MethodDataResolver.ResolveAllMethodData);
        TestExecutionRegistry.Instance.RegisterAsyncMethodDataResolver("MyTests.MyTest", MyTests_MyTest_MethodDataResolver.ResolveAllMethodDataAsync);
    }
}
