...
internal static class TestDictionary
{
    ...
    public static readonly GetOnlyDictionary<Type, Task<object?>> StaticInjectedPropertiesByInjectedType = new();
    public static readonly GetOnlyDictionary<Type, Queue<Task<object?>>> StaticInjectedPropertiesByTestClassType = new();
